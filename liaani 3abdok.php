...
<head>
	...
	<title> تحميل كتاب لأني عبدك</title>
...
<table border="3" bgcolor="#7884A9">
	...
	<center><h2> تحميل كتاب لأني عبدك</h2></center><br><br><br>
	<center>
	<table>
		<center><tr>
			...
			<td><img src="Religious Books/liaani 3abdok/liaani 3abdok.png" id="img"></td>
		</tr></center>
...
فمن أراد أن يجددّ النية للتعرّف عليه عز وجلّ من خلال أسمائه التي قد يجهل الكثير من معانيها ومدى قوتها وتأثيرها في حياته ، فعليه بهذا الكتاب الذي سيأخذهُ إلى عالم ربّاني أسمى، ويغير فيه الكثير للأحسن بإذنه تعالى .  
	...
	<br><br><br><br><center>
	<a href="Religious Books/liaani 3abdok/liaani 3bdok.pdf"><button id="titre">Reading PDF</button></a>
	<a href="Religious Books/liaani 3abdok/liaani 3bdok.rar"><button id="titre">Download</button></a></center>
